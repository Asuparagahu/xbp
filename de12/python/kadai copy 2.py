...
root = tk1.Tk()
root.title(u"shun calendar ")
root.geometry("755x530+100+100")
root["bg"] = "#EEEEE8"

label1 = tk1.Label(font=("seigo",26),anchor=tk1.CENTER, width=2)
label1["bg"] = "#EEEEE8" 
label1.place(x=50+500,  y=3) 

label2 = tk1.Label(font=("Meiryo UI",10),anchor=tk1.W, width=10)
label2["bg"] = "#EEEEE5" 
label2.place(x=120+500 ,y=8) 

label3 = tk1.Label(font=("Meiryo UI",12),anchor=tk1.W, width=10)
label3["bg"] = "#EEEEE8" 
label3.place(x=120+500, y=25) 
...
root.mainloop()
img_month  =tk1.PhotoImage(file="202201.png")